...
/**
 * AuthPage - Login/Registration toggle component
 *
 * - "Bejelentkezés" button always shows the login form
 * - "Regisztráció" button always shows the registration form
 * - Simple, modern, accessible UI
 */
function AuthPage() {
