...
const ajandekok = [
  ...
  { nev: 'Vidám bögre', leiras: 'Vidám bögre leírása', ar: 89940, kategoria: 'élmény', stilus_id: 6, image_url: 'vidambogre.jpg', link_url: 'https://bogrevaros.hu/Vidam-napot-bogre' },

  { nev: 'Wellness hétvége', leiras: 'Wellness hétvége leírása', ar: 103321, kategoria: 'élmény', stilus_id: 6, image_url: 'wellness.jpg', link_url: 'https://www.pihipakk.hu/csomag/wellness-es-romantika' },

  { nev: 'DIY kézműves készlet', leiras: 'DIY kézműves készlet leírása', ar: 49433, kategoria: 'élmény', stilus_id: 8, image_url: 'diy.jpg', link_url: 'https://hobbivilag.hu/products/diy-3d-kezforma-klon-keszlet' },

  { nev: 'Szakácskönyv', leiras: 'Szakácskönyv leírása', ar: 18038, kategoria: 'tárgy', stilus_id: 6, image_url: 'szakacskonyv.jpg', link_url: 'https://szoky.hu/termek/konyv/' },

  { nev: 'Sétarepülés', leiras: 'Sétarepülés leírása', ar: 2187, kategoria: 'tárgy', stilus_id: 8, image_url: 'letöltés.jpg', link_url: 'https://elmenyrepulesek.hu/uzlet/setarepules/budapest-latvanyossagai-setarepules' },

  { nev: 'Puzzle játék', leiras: 'Puzzle játék leírása', ar: 6459, kategoria: 'élmény', stilus_id: 2, image_url: 'puzzle.jpg', link_url: 'https://www.puzzlekucko.hu/termek/anatolian-1000-darabos-1143-doggies-in-the-bedroom' },

  { nev: 'Romantikus vacsora', leiras: 'Romantikus vacsora leírása', ar: 7247, kategoria: 'tárgy', stilus_id: 4, image_url: 'romvacs.jpg', link_url: 'https://meglepkek.hu/romantika-es-lanykeres/romantikus-vacsora-es-hajozas-a-dunan' },

  { nev: 'Egyedi póló', leiras: 'Egyedi póló leírása', ar: 11271, kategoria: 'tárgy', stilus_id: 3, image_url: 'egyedipolo.jpg', link_url: 'https://pamutlabor.hu/egyedi' },

  { nev: 'Csokoládé válogatás', leiras: 'Csokoládé válogatás leírása', ar: 52819, kategoria: 'élmény', stilus_id: 4, image_url: 'csokoladevalogatas.jpg', link_url: 'https://veghmeli.com/termek/kezzel-keszitett-bonbon-valogatas-egyedulalloan-szep-diszcsomagolasban/' },

  { nev: 'Színházjegy', leiras: 'Színházjegy leírása', ar: 102627, kategoria: 'élmény', stilus_id: 1, image_url: 'szinhaz.jpg', link_url: 'https://www.jegy.hu/ajandekkartya' },

  { nev: 'Gokartozás', leiras: 'Gokartozás leírása', ar: 75867, kategoria: 'élmény', stilus_id: 6, image_url: 'gokart.jpg', link_url: 'https://gokartvac.hu/idopont-foglalas-vaci-gokart-palya/' },
  ...
  { nev: 'Okosóra', leiras: 'Okosóra leírása', ar: 6474, kategoria: 'tárgy', stilus_id: 7, image_url: 'okosora.jpg', link_url: 'https://okosora-aktivitasmero.arukereso.hu/' },

  { nev: 'Parfüm', leiras: 'Parfüm leírása', ar: 16387, kategoria: 'tárgy', stilus_id: 3, image_url: 'parfum.jpg', link_url: 'https://www.notino.hu/parfumok/' },

  { nev: 'Társasjáték', leiras: 'Társasjáték leírása', ar: 39802, kategoria: 'élmény', stilus_id: 2, image_url: 'tarsas.jpg', link_url: 'https://tarsasjatekrendeles.hu/TOP_50' },

  { nev: 'Borkóstoló', leiras: 'Borkóstoló leírása', ar: 63357, kategoria: 'élmény', stilus_id: 6, image_url: 'borkost.jpg', link_url: 'https://elmenyplaza.hu/elmeny-kategoriak/gasztronomiai-kalandok/borkostolok' },

  { nev: 'Szabadulószoba', leiras: 'Szabadulószoba leírása', ar: 14323, kategoria: 'tárgy', stilus_id: 2, image_url: 'szabadulo.jpg', link_url: 'https://booking.neverland.hu/hu/gift' },

  { nev: 'Állatkerti belépő', leiras: 'Állatkerti belépő leírása', ar: 13523, kategoria: 'tárgy', stilus_id: 6, image_url: 'allatkert.jpg', link_url: 'https://tickets.zoobudapest.com/hu/' },

  { nev: 'Főzőtanfolyam', leiras: 'Főzőtanfolyam leírása', ar: 90698, kategoria: 'élmény', stilus_id: 3, image_url: 'fozotan.jpg', link_url: 'https://elmenyplaza.hu/elmeny-kategoriak/gasztronomiai-kalandok/fozotanfolyamok' },

  { nev: 'Masszázs utalvány', leiras: 'Masszázs utalvány leírása', ar: 3843, kategoria: 'tárgy', stilus_id: 1, image_url: 'masszazs.jpg', link_url: 'https://www.chmassage.hu/hu/ajandekutalvany' },

  { nev: 'Jegy koncertre', leiras: 'Jegy koncertre leírása', ar: 59592, kategoria: 'élmény', stilus_id: 3, image_url: 'koncert.jpg', link_url: 'https://www.budapestpark.hu/' },

  { nev: 'Tánctanfolyam', leiras: 'Tánctanfolyam leírása', ar: 62529, kategoria: 'élmény', stilus_id: 1, image_url: 'tanc.jpg', link_url: 'https://tancvalaszto.hu/kezdo-tanfolyamok.html' },

  { nev: 'Kertészeti szett', leiras: 'Kertészeti szett leírása', ar: 58481, kategoria: 'élmény', stilus_id: 4, image_url: 'kertesz.jpg', link_url: 'https://www.csepeligravir.hu/termek/kerteszeti-szett-gravirozas-nelkuli-termek/' },
  ...
  { nev: 'Plüssfigura', leiras: 'Plüssfigura leírása', ar: 10089, kategoria: 'tárgy', stilus_id: 8, image_url: 'hello-kitty_cursor.png', link_url: 'https://www.plussfigurabolt.hu/termek' },
  ...
  { nev: 'Napernyő', leiras: 'Napernyő leírása', ar: 42141, kategoria: 'élmény', stilus_id: 6, image_url: 'napernyo.jpg', link_url: 'https://www.napernyobolt.hu/termek' },
  ...
  { nev: 'LED lámpa', leiras: 'LED lámpa leírása', ar: 23426, kategoria: 'élmény', stilus_id: 1, image_url: 'ledlampa.jpg', link_url: 'https://www.ledlampabolt.hu/termek' },

  { nev: 'Szépségcsomag', leiras: 'Szépségcsomag leírása', ar: 6991, kategoria: 'tárgy', stilus_id: 3, image_url: 'szep.jpg', link_url: 'https://www.szepsegcsomag.hu/termek' },

  { nev: 'Fitness bérlet', leiras: 'Fitness bérlet leírása', ar: 18475, kategoria: 'tárgy', stilus_id: 8, image_url: 'jogaberlet.jpg', link_url: 'https://www.fitnessberlet.hu/termek' },
  ...
  { nev: 'Hangszóró', leiras: 'Hangszóró leírása', ar: 34263, kategoria: 'élmény', stilus_id: 5, image_url: 'hangszoro.jpg', link_url: 'https://www.hangszorobolt.hu/termek' },

  { nev: 'Bluetooth fülhallgató', leiras: 'Bluetooth fülhallgató leírása', ar: 101883, kategoria: 'élmény', stilus_id: 1, image_url: 'ful.jpg', link_url: null },
  ...
  { nev: 'Könyvcsomag', leiras: 'Könyvcsomag leírása', ar: 74363, kategoria: 'élmény', stilus_id: 1, image_url: 'konyvcsomag.jpg', link_url: null },

  { nev: 'Italválogatás', leiras: 'Italválogatás leírása', ar: 18626, kategoria: 'tárgy', stilus_id: 2, image_url: 'ital.jpg', link_url: null },

  { nev: 'Vezetéstechnikai tréning', leiras: 'Vezetéstechnikai tréning leírása', ar: 90593, kategoria: 'élmény', stilus_id: 1, image_url: 'trening.jpg', link_url: null },

  { nev: 'Nyári tábor belépő', leiras: 'Nyári tábor belépő leírása', ar: 107347, kategoria: 'élmény', stilus_id: 8, image_url: 'tabor.jpg', link_url: null },
  ...
  { nev: 'Bögre szett', leiras: 'Bögre szett leírása', ar: 33739, kategoria: 'élmény', stilus_id: 3, image_url: 'bogreszett.jpg', link_url: null },

  { nev: 'Hobbi magazin előfizetés', leiras: 'Hobbi magazin előfizetés leírása', ar: 48553, kategoria: 'élmény', stilus_id: 8, image_url: 'magazin.jpg', link_url: null },

  { nev: 'Kézműves csokoládé', leiras: 'Kézműves csokoládé leírása', ar: 2559, kategoria: 'tárgy', stilus_id: 6, image_url: 'kezcsoki.jpg', link_url: null },

  { nev: 'Gyertyakészlet', leiras: 'Gyertyakészlet leírása', ar: 3539, kategoria: 'tárgy', stilus_id: 1, image_url: 'gyertya.jpg', link_url: null },

  { nev: 'Retro játék konzol', leiras: 'Retro játék konzol leírása', ar: 32649, kategoria: 'élmény', stilus_id: 5, image_url: 'retrokonzol.jpg', link_url: null },
  ...
  { nev: 'Szappankészítő készlet', leiras: 'Szappankészítő készlet leírása', ar: 8345, kategoria: 'élmény', stilus_id: 4, image_url: 'szappan.jpg', link_url: 'https://hobbivilag.hu/szappankeszito' },

  { nev: 'Borkóstoló hétvége', leiras: 'Borkóstoló hétvége leírása', ar: 45210, kategoria: 'élmény', stilus_id: 6, image_url: 'borkost.jpg', link_url: 'https://elmenyplaza.hu/borkostolo' },
  ...
  { nev: 'Borkóstoló vacsora', leiras: 'Borkóstoló vacsora leírása', ar: 40999, kategoria: 'élmény', stilus_id: 6, image_url: 'borvacs.jpg', link_url: 'https://gasztroelmeny.hu/borkostolo' },
  ...
  { nev: 'Séta a városban', leiras: 'Séta a városban leírása', ar: 10200, kategoria: 'élmény', stilus_id: 2, image_url: 'seta.jpg', link_url: 'https://varoserteke.hu/seta' },
  ...
  { nev: 'Borkóstoló élmény', leiras: 'Borkóstoló élmény leírása', ar: 38500, kategoria: 'élmény', stilus_id: 6, image_url: 'bor.jpg', link_url: 'https://elmenyplaza.hu/borkostolo' },
  ...
  { nev: 'Hőlégballon túra', leiras: 'Hőlégballon túra leírása', ar: 84999, kategoria: 'élmény', stilus_id: 7, image_url: 'ballon.jpg', link_url: 'https://ballon.hu' },
  ...
  { nev: 'DIY dekoráció', leiras: 'DIY dekoráció leírása', ar: 7540, kategoria: 'élmény', stilus_id: 4, image_url: 'diy.jpg', link_url: 'https://hobbivilag.hu/dekoracio' },
