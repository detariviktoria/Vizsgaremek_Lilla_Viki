...
import InviteModal from '../Social/InviteModal';
...
import '../Gifts/KategoriaValasztas.css';
            ...
            <div className="card animate-slide-up transition-all duration-300 hover:scale-105 active:scale-95 [animation-delay:100ms]" onClick={() => navigate('/targy')}>
             ...
             <div className="invite-banner">
              ...
              <div className="invite-content">
                ...
                <button className="invite-btn" onClick={() => setIsInviteModalOpen(true)}>Meghívás indítása</button>
