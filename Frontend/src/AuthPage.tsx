      ...
      {mode === "register" ? (
        <div id="registration-div">
          ...
          <form autoComplete="off">
            ...
            <input type="password" placeholder="Jelszó" style={{ width: "100%", marginBottom: 16, padding: 8 }} required autoComplete="new-password" /><br />
        ...
        <div id="login-div">
          ...
          <form autoComplete="off">
            <label style={{ display: "block", marginBottom: 4 }}>Email</label>
            <input type="email" placeholder="Email" style={{ width: "100%", marginBottom: 12, padding: 8 }} required autoComplete="email" /><br />
            <label style={{ display: "block", marginBottom: 4 }}>Jelszó</label>
            <input type="password" placeholder="Jelszó" style={{ width: "100%", marginBottom: 16, padding: 8 }} required autoComplete="current-password" /><br />
